...
ALTER TABLE st
ADD COLUMN pdf_generador VARCHAR(255),
ADD COLUMN pdf_plano VARCHAR(255),
ADD COLUMN pdf_ppto VARCHAR(255),
ADD COLUMN pdf_factura VARCHAR(255),
ADD COLUMN xml VARCHAR(255);
