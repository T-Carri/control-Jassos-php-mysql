...
const estados = [
  ...
  function toggleNavbar() {
    ...
    if (navbar.style.marginTop === '' || navbar.style.marginTop === '0px') {
        navbar.style.marginTop = '-80px'; // Altura del Navbar
        content.style.marginTop = '0';
        resetBtn.style.display = 'block';
    } else {
        navbar.style.marginTop = '0';
        content.style.marginTop = '80px';
        resetBtn.style.display = 'block';  // Cambiado a 'block' en lugar de 'none'
    }
}
